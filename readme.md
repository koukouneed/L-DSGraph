...
- **训练结果** (Training Results): Summary of all experiments
- **Per-config sheets**: Detailed per-configuration results
- **统计检验** (Statistical Tests): Wilcoxon and Â₁₂ results
- **逐程序语句排名** (Per-Program Statement Ranks): Line-level rank details
